...
// --- Bitacora Digital (Logbook) types ---
...
export interface LogbookFlightRow {
  id: string
  entry_id: string
...
export interface LogbookEntryWithFlights extends LogbookEntryRow {
  flights: LogbookFlightRow[]
}

export interface LogbookStatsRow {
  user_id: string
