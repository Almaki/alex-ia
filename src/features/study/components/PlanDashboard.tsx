    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        {filteredTopics.length > 0 ? (
          ...
          <div className="bg-gray-900/50 border border-white/10 rounded-2xl p-12 text-center backdrop-blur-sm">
            <p className="text-gray-400">No hay topics para esta semana</p>
          </div>
        )}
      </div>
      ...
      <div className="flex gap-3">
        <button
          ...
          className="flex-1 py-4 px-6 bg-gradient-to-r from-emerald-500 to-green-500 text-white font-semibold rounded-xl hover:from-emerald-600 hover:to-green-600 transition-all duration-200 shadow-lg hover:shadow-xl hover:shadow-emerald-500/20"
        >
          Completar Plan
        </button>
        <button
          onClick={onArchivePlan}
          className="px-6 py-4 bg-white/5 border border-white/10 text-gray-300 font-medium rounded-xl hover:bg-white/10 transition-all"
        >
          Archivar
        </button>
      </div>
